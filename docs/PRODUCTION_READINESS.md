...
| Database changes | Preview target restored and migrated | The 2026-09-04 resolution in `docs/CHECKPOINT_STATUS.md` reconnected Preview to the ledgered Neon target `restless-frost-04247280/br-hidden-mode-ax99b5h6`, confirmed live through `neon.branch_id`, and applied the tenth migration behind the fail-closed target guard with prior records intact. Still required: backup and restore evidence, and re-proving data-flow claims that predate this correction. |
