...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Free release impact review \u00b7 PlaywrightGen", description: "Describe a change before it ships and get its direct and downstream impact, the failure modes to guard against, and concrete Given/When/Then tests." , images: [SHARE_IMAGE] },
