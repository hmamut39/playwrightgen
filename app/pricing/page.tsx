...
const plans = [
  ...
  },
  {
    ...
    features: [
      "Cover a whole page: planned tests, proven in a real browser",
      "Review and approval, with every version kept",
      "Daily checks on your live site, with Slack or Discord alerts",
      "Pull requests with approved tests, straight to your repository",
      "Your editor’s AI can use it (Cursor, VS Code, Claude Code)",
      "Release evidence: what passed, on which version, when",
    ],
    cta: "Open Workspace",
    href: "/workspace",
    featured: true,
